    ...
    <section id="services-section" class="px-12 lg:px-32 py-16 relative overflow-hidden" style="background: var(--color-secondary)">
      ...
      <div class="flex flex-col md:flex-row md:gap-8">
        <div class="flex flex-row md:flex-col justify-between md:justify-start items-center md:items-start my-8 md:w-1/3">
          <img src="/assets/services/wedding.png" alt="Wedding" class="-z-50 md:mb-4" onerror="this.onerror=null;this.src='/assets/placeholder.svg?height=100&width=100';" />
        ...
        <div class="flex flex-row md:flex-col justify-between items-center md:items-start my-8 md:w-1/3">
          ...
          <img src="/assets/services/lifestyle.png" alt="Lifestyle" class="-z-50 md:mb-4 md:order-1" onerror="this.onerror=null;this.src='/assets/placeholder.svg?height=100&width=100';" />
        </div>
        <div class="flex flex-row md:flex-col justify-between items-center md:items-start my-8 md:w-1/3">
          <div class="w-1/3">
            <img src="/assets/services/moments.png" alt="Moments" class="-z-50 md:mb-4" onerror="this.onerror=null;this.src='/assets/placeholder.svg?height=100&width=100';" />
          </div>
          <div class="w-2/3 text-right md:text-left md:w-full">
